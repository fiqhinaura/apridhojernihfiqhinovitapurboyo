...
<html lang="en" data-bs-theme="auto">
  ...
  <body class="sb-nav-fixed">
	...
	<a href="tambah1.php"><button type="button" class="btn btn-success">Tambah Alat Medis</button></a>
	<br/>
	<br/>
	<table class="table table-striped table-sm" border="1">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
				<a href="edit1.php?kode_alat=<?php echo $d['kode_alat']; ?>"><button type="button" class="btn btn-primary"><i
                    class="fa fa-edit"></i>Edit</button></a>
              <a href="hapus1.php?kode_alat=<?php echo $d['kode_alat']; ?>"><button type="button" class="btn btn-danger"><i
	...
	<a href="print1.php" target="_blank" class="btn btn-warning">Print</a>
