...
<head>
	<title>CRUD PHP dan MySQLi - FIQHI NAURA</title>
</head>
<body>

	<a href="obat.php" class="btn btn-danger">Kembali</a>
	<br/>
	<br/>
	...
	$data = mysqli_query($koneksi,"select * from obat where kode_obat='$kode_obat'");
		...
		<form method="post" action="update.php">
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="hidden" name="kode_obat" class="form-control" value="<?php echo $d['kode_obat']; ?>">
                <input type="text" name="nama_obat" class="form-control" id="inputnamaomat" placeholder=""
			...
			<div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="text" name="jenis" class="form-control" id="inputnamaomat" placeholder=""
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="text" name="fungsi" class="form-control" id="inputnamaomat" placeholder=""
                  value="<?php echo $d['fungsi']; ?>">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="text" name="stock" class="form-control" id="inputnamaomat" placeholder=""
                  value="<?php echo $d['stock']; ?>">
              </div>
            </div>
