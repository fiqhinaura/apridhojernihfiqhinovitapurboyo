        ...
        <form method="post" action="update.php">
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="kode_obat" class="form-control" id="inputnamaobat" placeholder="">
            </div>
            <br>
            <br>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" name="nama_obat" class="form-control" id="inputnamaobat" placeholder="">
              </div>
            </div>
            <br>
            <div class="row mb-3">
              <label for="inputPassword3" class="col-sm-2 col-form-label">Jenist</label>
              <div class="col-sm-10">
                <input type="text" name="nama_obat" class="form-control" id="inputnamaobat" placeholder="">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="text" name="fungsi" class="form-control" id="inputnamaobat" placeholder="">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="text" name="stock" class="form-control" id="inputnamaobat" placeholder="">
              </div>
            </div>
